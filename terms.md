...
In special cases there are tours that will demand different payment plan, these information will be passed to the client prior to payment.
...
Invoices are processed no later than 5 days of the service or the payment, which ever comes first. Details of lead traveller are filled as purchasing entity and cannot be changed after the invoice is issued. Therefore, if you desire an invoice with a different purchasing entity you need to request it in advance (e.g. time of booking). 
...
####5. Trip or Tour Cancellation

If hazard weather conditions occur, we can try to reschedule your tour to the nearest date possible, though not changing other tours previously booked to other clients. If the tour does not happen we will refund you on 100%. In case of this type cancellation, all deposits and other payments for the tour or tour extension will be refunded. 
...
####10. Restrictions on Participants
...
####12. Discharge of Pressurised Air into the Lifejackets.
...
No goods are allowed to be transported without written consent and in compliance with Portuguese Law. By these we mean that all that comes into the vans and boats at start point can only leave at finish point. (e.g. Not leaving anything in Desertas Islands, not bringing anything from Desertas Islands). In other words no smuggling.

####14. Forbidden Consumption
...
The website [windbirds.co](https://windbirds.co/) with a valid SSL Certificate holds legal documents for Wind Birds, Lda and guarantees safe communication between us and clients.

Under Portuguese Law documents electronically signed by our management with "Cartao de Cidadao" (Portuguese Citizen iD Card) have legal value. A copy of such document is stored on [windbirds.co](https://windbirds.co/) and is accessible via QR Code imprinted on the document.

####18. External Observer/Researcher/Law Enforcement Agent Charge
