...
Notice to Users in the European Union, California, Colorado, and Virginia: This privacy statement has been prepared to comply with the following data protection and privacy regulations:

* European Union's General Data Protection Regulation (GDPR), which replaced Directive 95/46/EC and updated the provisions of Directive 2002/58/EC, as amended by Directive 2009/136/EC.
* California Consumer Privacy Act (CCPA) for users in California, United States.
* Colorado Privacy Act (CPA) for users in Colorado, United States.
* Virginia Consumer Data Protection Act (VCDPA) for users in Virginia, United States.

This statement addresses the collection, usage, storage, and disclosure of personal information, as well as the rights of users concerning their data under these respective laws and regulations.
...
_Updated March 18, 2023 v3.2 https://windbirds.co/privacy_
